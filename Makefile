SOURCES = ft_atoi.c ft_bzero.c ft_isalnum.c ft_isalpha.c ft_isascii.c \
		  ft_isdigit.c ft_islower.c ft_isprint.c ft_isupper.c ft_iswhite.c \
		  ft_itoa.c ft_lstadd.c ft_lstaddr.c ft_lstdel.c ft_lstdelone.c \
		  ...
		  ft_putstr_fd.c ft_strcat.c ft_strchr.c ft_strclen.c ft_strclr.c \
		  ...
		  ft_lstsimplefree.c ft_lstgetr.c ft_strccpy.c
OBJECTS = $(SOURCES:.c=.o)
INCLUDE = -I.
